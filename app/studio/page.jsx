...
const Contact = () => {
    return (
        <div className="min-w-[80%] h-100 mt-20">
            <div className="bg-[#dddedf] w-40 h-10 text-sm flex justify-center items-center ml-15 relative rounded-t-xl text-black">
            ...
            <div className="h-90 w-full bg-[#dddedf] rounded-sm border border-[#dddedf] flex flex-col justify-center">
               <div className="max-w-lg mx-auto">
                 <p className="text-black text-sm max-w-lg">If you're an artist, designer, or brand building something beautiful. I'd love to help you shape your online presence.
                    Let's create something timeless, together.
                </p>
                <div className="text-sm py-2 border-y border-y-black text-black mt-10">
                Get in touch: <Link href='/' className="ml-5">@sumonadotwork@gmail.com</Link>
                </div>
               </div>
            </div>
        </div>
